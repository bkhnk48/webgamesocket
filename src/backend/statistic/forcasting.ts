...
export class Forcasting{
    ...
    public averageAverageNormalWaitingTime : number = 0;//of normal Auto AGV
    public averageAverageEmergencyWaitingTime : number = 1;//of normal Auto AGV
    public pausingTime: number = 1;
    ...
    public calculate(): void{
        ...
        let numAutoAgv : number = this.waitingAutoAgv?.size as number;
        //let result : number = 0;
        if(numAutoAgv != 0) this.averageAverageNormalWaitingTime = total/numAutoAgv;
        //if(this.averageAverageWaitingTime < 1)
        //    this.averageAverageWaitingTime = 1;
        this.averageAverageNormalWaitingTime = Math.floor(this.averageAverageNormalWaitingTime*100)/100;
    }
}