...
export class Constant {
    ...
    public static getEmergencyMoving = (x: number) => 12*x; 
    //hàm tính chi phí thiệt hại nếu di chuyển ở chế độ khẩn cấp trên các edge
    public static get SAFE_DISTANCE() : number { return 46;}
    public static get DELTA_T() : number { return 10;}
    public static get MODE() : ModeOfPathPlanning { return ModeOfPathPlanning.PROPOSE;}
